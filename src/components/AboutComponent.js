  ...
  render() {
    return (
      <div>
        ...
        <h3>
          If you FEEL first before you communicate, you'll build stronger relationships through all of your
          ...
          will resonate and your relationships will grow stronger with the people that matter.
        </h3>
